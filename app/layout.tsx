...
export const metadata: Metadata = {
  ...
  description:
    ...
    generator: 'Car City: Revolutionizing Car Care with AI-Powered Solutions. Searching for reliable car services in Dhaka just got easier! Car City leverages cutting-edge AI technology to connect you with trusted professionals for rentals, repairs, parts, and more.'
}
